...
# 사용할 CLIP 모델 목록
models_info = [
    {"name": "laion/CLIP-ViT-H-14-laion2B-s32B-b79K", "db_path": "chroma_db/CLIP-ViT-H-14-laion2B-s32B-b79K"},
    {"name": "openai/clip-vit-large-patch14-336", "db_path": "chroma_db/clip-vit-large-patch14-336"}
]
