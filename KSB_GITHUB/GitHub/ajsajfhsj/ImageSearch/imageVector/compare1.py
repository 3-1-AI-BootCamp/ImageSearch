...
# 사용할 CLIP 모델 목록
models_info = [
    {"name": "OFA-Sys/chinese-clip-vit-base-patch16", "db_path": "chroma_db/chinese-clip-vit-base-patch16", "is_chinese_clip": True},
    {"name": "UCSC-VLAA/ViT-L-16-HTxt-Recap-CLIP", "db_path": "chroma_db/UCSC-VLAA_ViT-L-16-HTxt-Recap-CLIP", "is_chinese_clip": False}
]
...
for model_info in models_info:
    ...
    is_chinese_clip = model_info.get("is_chinese_clip", False)
